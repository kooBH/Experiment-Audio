...
for idx in 0 1 2 3 ; do
  for i in /home/data/CHiME4_bth_5ch/*${arr_dir[$idx]}_simu; do
    ...
    for j in $(ls $i); do
      ...
      echo ./DS20921 $wav_root'/'Clean'/'$j  $wav_root'/'${NOISE}'/'$j   $outpath'/MEMS/'$dir'/'$j $outpath'/DS20921/'$dir'/'$j
      ./DS20921 $wav_root'/'Clean'/'$j  $wav_root'/'${NOISE}'/'$j   $outpath'/MEMS/'$dir'/'$j $outpath'/DS20921/'$dir'/'$j
	  break
    done
	  break
  done
