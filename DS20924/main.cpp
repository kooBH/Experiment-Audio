...
int main(int argc, char** argv) {
  ...
  DS20924FW recorder_924FW(argv[1],argv[5],argv[2],CHANNELS_3,DEVICE_3,SAMPLERATE_2);
  ...
  nRead_a= ftell(fp_a)-44;  // 44 : WAV format head size
  ...
  thread_record_3= new std::thread(&DS20924FW::Process,&recorder_924FW);
