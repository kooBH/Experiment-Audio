...
#define DEVICE_MEMS 20 // USBStreamer Multi-channels
#define DEVICE_921 10 //I2S RX 16K TX 48K
#define DEVICE_CLEAN 3 // Sound Blaster X-Fi Surround 5.1 Pro
#define DEVICE_NOISE_1 5 // Studio-Capture 1-2 to laptob
